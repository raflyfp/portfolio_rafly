...
export default function AdminLayout({ title, children }) {
    ...
    return (
        <div className="min-h-screen bg-[#050506] text-white">
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-72 border-r border-white/10 bg-zinc-950/90 p-4 backdrop-blur-xl transition md:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
